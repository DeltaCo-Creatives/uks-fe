...
- Source: https://uks.kemendikdasmen.go.id/sekolah-sehat/mitra-sekolah-sehat
- Inertia component: `Program/Show` · published 2023-05-07
- Raw HTML length: 206,080 chars · hosted images: 0 · embedded base64 images: 1 · links: 1

> Scraped 2026-09-17 from the live CMS. Text is verbatim; layout blocks are marked with `---`.
...
[embedded base64 image 898×272]

Tertarik Menjadi Mitra, klik tautan berikut ini : [Daftar Menjadi Mitra](http://ringkas.kemdikbud.go.id/RegiscalonmitraKSS)
